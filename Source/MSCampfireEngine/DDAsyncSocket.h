...
@class DDAsyncSocket;
@class DDAsyncReadPacket;
@class DDAsyncWritePacket;

extern NSString *const DDAsyncSocketException;
extern NSString *const DDAsyncSocketErrorDomain;

enum DDAsyncSocketError
{
...
typedef enum DDAsyncSocketError DDAsyncSocketError;

@interface NSObject (DDAsyncSocketDelegate)
 ...
 **/
- (void)onSocket:(DDAsyncSocket *)sock didAcceptNewSocket:(DDAsyncSocket *)newSocket;

/**
 * Called when a new socket is spawned to handle a connection.  This method should return the run-loop of the
 * thread on which the new socket and its delegate should operate. If omitted, [NSRunLoop currentRunLoop] is used.
 **/
- (NSRunLoop *)onSocket:(DDAsyncSocket *)sock wantsRunLoopForNewSocket:(DDAsyncSocket *)newSocket;
 ...
 **/
- (BOOL)onSocketWillConnect:(DDAsyncSocket *)sock;
 ...
 **/
- (void)onSocket:(DDAsyncSocket *)sock didReadPartialDataOfLength:(CFIndex)partialLength tag:(long)tag;
 ...
 * It may be used to for things such as updating progress bars.
 **/
- (void)onSocket:(DDAsyncSocket *)sock didWritePartialDataOfLength:(CFIndex)partialLength tag:(long)tag;
 ...
 **/
- (NSTimeInterval)onSocket:(DDAsyncSocket *)sock
...
@interface DDAsyncSocket : NSObject
{
	...
	DDAsyncReadPacket *theCurrentRead;
	NSTimer *theReadTimer;
	NSMutableData *partialReadBuffer;
	
	NSMutableArray *theWriteQueue;
	DDAsyncWritePacket *theCurrentWrite;
